...
\ cost. It is a deterministic, arithmetic-heavy workload (~39M dispatched ops at
\ n=10000: ~43% MUX, ~57% SUBLEQ): 'make bench-forth' times it, and the printed
\ checksum is the golden that guards the generator.
decimal
